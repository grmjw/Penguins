...
#define NODE_MAIN_LOGGER_NAME "os_cloud"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libos_cloud_component.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<ouster_ros::OusterCloud>";
