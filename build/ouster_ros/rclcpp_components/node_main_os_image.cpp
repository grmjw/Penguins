...
#define NODE_MAIN_LOGGER_NAME "os_image"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libos_image_component.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<ouster_ros::OusterImage>";
