...
#define NODE_MAIN_LOGGER_NAME "os_driver"
...
int main(int argc, char * argv[])
{
  ...
  std::string library_name = "libos_driver_component.so";
  std::string class_name = "rclcpp_components::NodeFactoryTemplate<ouster_ros::OusterDriver>";
