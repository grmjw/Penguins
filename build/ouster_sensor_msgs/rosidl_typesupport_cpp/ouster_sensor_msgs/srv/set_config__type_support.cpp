...
static const _SetConfig_Request_type_support_symbol_names_t _SetConfig_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ouster_sensor_msgs, srv, SetConfig_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ouster_sensor_msgs, srv, SetConfig_Request)),
  }
};
...
get_message_type_support_handle<ouster_sensor_msgs::srv::SetConfig_Request>()
{
  return &::ouster_sensor_msgs::srv::rosidl_typesupport_cpp::SetConfig_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, ouster_sensor_msgs, srv, SetConfig_Request)() {
  return get_message_type_support_handle<ouster_sensor_msgs::srv::SetConfig_Request>();
}
...
static const _SetConfig_Response_type_support_symbol_names_t _SetConfig_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ouster_sensor_msgs, srv, SetConfig_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ouster_sensor_msgs, srv, SetConfig_Response)),
  }
};
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
get_message_type_support_handle<ouster_sensor_msgs::srv::SetConfig_Response>()
{
  return &::ouster_sensor_msgs::srv::rosidl_typesupport_cpp::SetConfig_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, ouster_sensor_msgs, srv, SetConfig_Response)() {
  return get_message_type_support_handle<ouster_sensor_msgs::srv::SetConfig_Response>();
}
...
static const _SetConfig_type_support_symbol_names_t _SetConfig_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ouster_sensor_msgs, srv, SetConfig)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ouster_sensor_msgs, srv, SetConfig)),
  }
};
...
get_service_type_support_handle<ouster_sensor_msgs::srv::SetConfig>()
{
  return &::ouster_sensor_msgs::srv::rosidl_typesupport_cpp::SetConfig_service_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_cpp, ouster_sensor_msgs, srv, SetConfig)() {
  return ::rosidl_typesupport_cpp::get_service_type_support_handle<ouster_sensor_msgs::srv::SetConfig>();
}
