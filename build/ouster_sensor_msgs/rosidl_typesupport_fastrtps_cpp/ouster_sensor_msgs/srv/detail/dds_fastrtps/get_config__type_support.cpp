...
#include "ouster_sensor_msgs/srv/detail/get_config__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const ouster_sensor_msgs::srv::GetConfig_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ouster_sensor_msgs::srv::GetConfig_Request & ros_message)
{
  // Member: structure_needs_at_least_one_member
  cdr >> ros_message.structure_needs_at_least_one_member;
...
{
  auto typed_message =
    static_cast<const ouster_sensor_msgs::srv::GetConfig_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<ouster_sensor_msgs::srv::GetConfig_Request *>(
    untyped_ros_message);
...
{
  return &ouster_sensor_msgs::srv::typesupport_fastrtps_cpp::_GetConfig_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ouster_sensor_msgs, srv, GetConfig_Request)() {
  return &ouster_sensor_msgs::srv::typesupport_fastrtps_cpp::_GetConfig_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_ouster_sensor_msgs
cdr_serialize(
  const ouster_sensor_msgs::srv::GetConfig_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: config
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  ouster_sensor_msgs::srv::GetConfig_Response & ros_message)
{
  // Member: config
  cdr >> ros_message.config;
...
{
  auto typed_message =
    static_cast<const ouster_sensor_msgs::srv::GetConfig_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<ouster_sensor_msgs::srv::GetConfig_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &ouster_sensor_msgs::srv::typesupport_fastrtps_cpp::_GetConfig_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ouster_sensor_msgs, srv, GetConfig_Response)() {
  return &ouster_sensor_msgs::srv::typesupport_fastrtps_cpp::_GetConfig_Response__handle;
}
...
{
  return &ouster_sensor_msgs::srv::typesupport_fastrtps_cpp::_GetConfig__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, ouster_sensor_msgs, srv, GetConfig)() {
  return &ouster_sensor_msgs::srv::typesupport_fastrtps_cpp::_GetConfig__handle;
}
