...
{
  new (message_memory) ouster_sensor_msgs::msg::PacketMsg(_init);
}

void PacketMsg_fini_function(void * message_memory)
{
  auto typed_message = static_cast<ouster_sensor_msgs::msg::PacketMsg *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember PacketMsg_message_member_array[1] = {
  {
    ...
    offsetof(ouster_sensor_msgs::msg::PacketMsg, buf),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers PacketMsg_message_members = {
  ...
  1,  // number of fields
  sizeof(ouster_sensor_msgs::msg::PacketMsg),
...
{
  return &::ouster_sensor_msgs::msg::rosidl_typesupport_introspection_cpp::PacketMsg_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, ouster_sensor_msgs, msg, PacketMsg)() {
  return &::ouster_sensor_msgs::msg::rosidl_typesupport_introspection_cpp::PacketMsg_message_type_support_handle;
}
