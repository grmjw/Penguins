...
#ifndef COM_MASTER_UMRR9F_T169_AUTOMOTIVE_V2_1_1_DATA_SERVICE_IFACE_H
#define COM_MASTER_UMRR9F_T169_AUTOMOTIVE_V2_1_1_DATA_SERVICE_IFACE_H


#include <VersionedIface.h>
#include <ExternalTypes.h>
#include <umrr9f_t169_automotive_v2_1_1/comtargetbaselist/ComTargetBaseList.h>
#include <umrr9f_t169_automotive_v2_1_1/comtargetlist/ComTargetList.h>
#include<functional>
...
// CALLBACKS
typedef std::function<void(std::shared_ptr<com::master::umrr9f_t169_automotive_v2_1_1::comtargetbaselist::ComTargetBaseList>, com::types::ClientId clientId)>
 ReceiveComTargetBaseListCallback;
typedef std::function<void(std::shared_ptr<com::master::umrr9f_t169_automotive_v2_1_1::comtargetlist::ComTargetList>, com::types::ClientId clientId)>
...
#endif // COM_MASTER_UMRR9F_T169_AUTOMOTIVE_V2_1_1_DATA_SERVICE_IFACE_H