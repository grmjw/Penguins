...
#ifndef COM_MASTER_UMRR11_T132_AUTOMOTIVE_V1_1_2_DATA_SERVICE_IFACE_H
#define COM_MASTER_UMRR11_T132_AUTOMOTIVE_V1_1_2_DATA_SERVICE_IFACE_H


#include <VersionedIface.h>
#include <ExternalTypes.h>
#include <umrr11_t132_automotive_v1_1_2/comtargetbaselist/ComTargetBaseList.h>
#include <umrr11_t132_automotive_v1_1_2/comtargetlist/ComTargetList.h>
#include<functional>
...
// CALLBACKS
typedef std::function<void(std::shared_ptr<com::master::umrr11_t132_automotive_v1_1_2::comtargetbaselist::ComTargetBaseList>, com::types::ClientId clientId)>
 ReceiveComTargetBaseListCallback;
typedef std::function<void(std::shared_ptr<com::master::umrr11_t132_automotive_v1_1_2::comtargetlist::ComTargetList>, com::types::ClientId clientId)>
...
#endif // COM_MASTER_UMRR11_T132_AUTOMOTIVE_V1_1_2_DATA_SERVICE_IFACE_H