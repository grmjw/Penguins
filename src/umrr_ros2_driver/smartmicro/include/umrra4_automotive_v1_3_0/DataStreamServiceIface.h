...
#ifndef COM_MASTER_UMRRA4_AUTOMOTIVE_V1_3_0_DATA_SERVICE_IFACE_H
#define COM_MASTER_UMRRA4_AUTOMOTIVE_V1_3_0_DATA_SERVICE_IFACE_H


#include <VersionedIface.h>
#include <ExternalTypes.h>
#include <umrra4_automotive_v1_3_0/comtargetbaselist/ComTargetBaseList.h>
#include <umrra4_automotive_v1_3_0/comtargetlist/ComTargetList.h>
#include<functional>
...
// CALLBACKS
typedef std::function<void(std::shared_ptr<com::master::umrra4_automotive_v1_3_0::comtargetbaselist::ComTargetBaseList>, com::types::ClientId clientId)>
 ReceiveComTargetBaseListCallback;
typedef std::function<void(std::shared_ptr<com::master::umrra4_automotive_v1_3_0::comtargetlist::ComTargetList>, com::types::ClientId clientId)>
...
#endif // COM_MASTER_UMRRA4_AUTOMOTIVE_V1_3_0_DATA_SERVICE_IFACE_H