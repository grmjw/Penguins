...
#ifndef COM_MASTER_UMRR9F_T169_AUTOMOTIVE_V2_2_0_DATA_SERVICE_IFACE_H
#define COM_MASTER_UMRR9F_T169_AUTOMOTIVE_V2_2_0_DATA_SERVICE_IFACE_H


#include <VersionedIface.h>
#include <ExternalTypes.h>
#include <umrr9f_t169_automotive_v2_2_0/comtargetlistport/ComTargetListPort.h>
#include <umrr9f_t169_automotive_v2_2_0/diagnosticport/DiagnosticPort.h>
#include<functional>
...
// CALLBACKS
typedef std::function<void(std::shared_ptr<com::master::umrr9f_t169_automotive_v2_2_0::comtargetlistport::ComTargetListPort>, com::types::ClientId clientId)>
 ReceiveComTargetListPortCallback;
typedef std::function<void(std::shared_ptr<com::master::umrr9f_t169_automotive_v2_2_0::diagnosticport::DiagnosticPort>, com::types::ClientId clientId)>
...
#endif // COM_MASTER_UMRR9F_T169_AUTOMOTIVE_V2_2_0_DATA_SERVICE_IFACE_H